...
class _CommentScreenState extends State<CommentScreen> with AnimationMixin {
                              ...
                              itemBuilder: (context, indext) {
                                if (indext % 2 == 0) {
                                  ...
                                  return CommetItem(
                                    size: size,
                                    des:
                                        "When things get hectic, sometimes we just need some happy quotes to get us inspired and help us make it through the day, month, or year.😍😀😄😁",
                                    name: 'Srimal Mendis',
                                    url:
                                        "https://firebasestorage.googleapis.com/v0/b/agri-app-f387a.appspot.com/o/images%2Fusers%2F20221017102734633747.png?alt=media&token=2a425be7-26ca-4273-879e-24a133206804",
                                  );
                                }
                              })),
                      Align(
